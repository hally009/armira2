...
<main>
    ...
    <p>di- Tempat</p>
    <p class="mt-05">
        Sehubungan dengan surat nomor {{ $form->nomor_surat }} tanggal {{ human_date($form->tanggal_surat) }} hal {{ $form->perihal_surat }}, dengan ini diberitahukan bahwa permohonan Penghapusan Barang Milik Negara Berupa Bongkaran pada Perwakilan Badan Kependudukan dan Keluarga Berencana Nasional Provinsi{{ $item->satker->name }} dengan harga perolehan/nilai buku sebesar {{ $form->nilai_limit }} {{ terbilang($form->nilai_limit) }} sebagaimana tercantum dalam lampiran surat ini, pada prinsipnya dapat disetujui dengan ketentuan penjualan dilaksanakan secara lelang.
    </p>
    <p class="mt-05">
    ...
    <ol style="margin-top: 1cm">
        ...
        <li>
            Penjualan secara lelang atas Barang Milik Negara agar dilakukan melalui Kantor Pelayanan Kekayaan Negara dan Lelang (KPKNL) berdasarkan hasil penilaian tim penghapusan dan hasil penjualan seluruhnya disetor ke Kas Umum Negara.
        </li>
        ...
        <li>
            Satuan Kerja menyampaikan laporan pelaksanaan Penjualan secara lelang dan pelaksanaan Penghapusan barang kepada Pengelola Barang c.q. KPKNL {{ $item->satker->kpknl }} paling lama 1 (satu) bulan sejak Keputusan Penghapusan ditandatangani dengan melampirkan Risalah Lelang, Berita Acara Serah Terima, dan bukti setor ke Rekening Kas Umum Negara.
        </li>
        <li>
