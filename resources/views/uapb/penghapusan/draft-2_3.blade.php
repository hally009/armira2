    ...
    <table style="margin-top:1cm">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <p>
                        bahwa berdasarkan surat persetujuan Kepala Kantor Pelayanan Kekayaan Negara dan Lelang {{ $item->satker->kpknl }}  Nomor {{ $form->nomor_surat_persetujuan }} tentang {{ $form->perihal_surat_persetujuan }};
                    </p>
                </td>
            </tr>
            <tr>
