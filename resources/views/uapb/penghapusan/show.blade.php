            ...
            <div class="card-header pt-0 pe-0 pb-0">
                <div class="row">
                    <div class="col-md-6 bg-light ps-0 pe-0">
                        ...
                        <h6 class="mb-0 py-0 ms-3">Lampiran dokumen penghapusan BMN</h6>
                    </div>
                    <div class="col-md-6 ps-0 align-self-center">
                        <div class="d-flex justify-content-end align-items-center">
                            @include('uapb.penghapusan._table-show')
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row mt-3">
                    <div class="col-md-5 align-self-center">
                        <a type="button" href="{{ route('Uapb::penghapusan.index') }}" class="btn btn-outline-secondary me-1">
                            Kembali
                        </a>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <form id="aggreement-form" action="{{ route('Uapb::penghapusan.approve', $item) }}" method="POST" class="d-none">
                                @method('PUT')
                                @csrf
                            </form>
                            @endif
                            ...
                            <a type="button" target="blank" href="{{ route('Uapb::penghapusan.draft', $item) }}" class="btn btn-outline-success me-1">
                ...
                <hr>
                @include('uapb.penghapusan._show-file')
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-small">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" id="uploadSk" action="{{ route('Uapb::penghapusan.repeat', $item) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="col-md-12">
...
<div class="modal fade" id="modal-rejected" tabindex="-1">
    <div class="modal-dialog modal-small">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" id="uploadSk" action="{{ route('Uapb::penghapusan.rejected', $item) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="keterangan">
...
<div class="modal fade" id="modal-upload" tabindex="-1">
    <div class="modal-dialog modal-small">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" id="uploadSk" action="{{ route('Uapb::penghapusan.uploadsk', $item) }}" method="POST" enctype="multipart/form-data">
                    @method('POST')
                    @csrf
                    <div class="col-md-12">
