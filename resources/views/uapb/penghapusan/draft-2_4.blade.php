...
<main>
    ...
    <table style="margin-top:1cm">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <p>
                        bahwa berdasarkan surat Kepala Satuan Kerja {{ $item->satker->name }} Nomor {{ $form->nomor_sk }} tentang {{ $form->perihal_sk }};
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <p class="mb-05">
                        bahwa berdasarkan pertimbangan sebagaimana dimaksud dalam huruf a, huruf b, dan huruf c, perlu menetapkan Keputusan Kepala Badan Kependudukan dan Keluarga Berencana Nasional tentang Penghapusan Barang Milik Negara dari Daftar Barang Kuasa Pengguna {{ $item->satker->name }} 
                    </p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <p class="mb-05">
                        KEPUTUSAN KEPALA BADAN KEPENDUDUKAN DAN KELUARGA BERENCANA NASIONAL TENTANG PENGHAPUSAN BARANG MILIK NEGARA DARI DAFTAR BARANG KUASA PENGGUNA {{ $item->satker->name }}.
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <p class="mb-05">
                        Menghapuskan Barang Milik Negara berupa Barang Persediaan dari daftar barang Kuasa Pengguna {{ $item->satker->name }} sebagaimana tercantum dalam Lampiran yang merupakan bagian tidak terpisahkan dari Keputusan ini;
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2">
                    <p class="mb-05">
                        Penghapusan berupa Barang Persediaan sebagaimana dimaksud dalam Diktum KESATU:
                        <ol type="a">
                            <li>
                                penghapusan Barang Milik Negara berupa Barang Persediaan tersebut tidak mengganggu tugas operasional kantor;
                            </li>
                            <li>
                                Kuasa Pengguna Barang Perwakilan Badan Kependudukan dan Keluarga Berencana Nasional Provinsi {{ $item->satker->name }} menyampaikan Laporan Pelaksanaan Penghapusan Barang Milik Negara berupa Barang Persediaan kepada Kementerian Keuangan c.q. KPKNL {{ $item->satker->kpknl }} paling lama 1 (satu) bulan sejak Keputusan Penghapusan Barang Milik Negara ditetapkan, dengan melampirkan Berita Acara Serah Terima Barang Milik Negara, Foto, dan Keputusan Penghapusan yang ditetapkan; 
                            </li>
                            <li>
                                kebenaran materiil atas jenis, jumlah, tahun, dan nilai Barang Milik Negara yang dihapuskan serta semua biaya pelaksanaan penghapusan Barang Milik Negara tersebut menjadi tanggung jawab Kuasa Pengguna Barang {{ $item->satker->name }}; dan
                            </li>
                        </ol>
                    </p>
                </td>
    ...
    <ol class="left">
        ...
        <li>Sekretaris {{ $item->satker->name }};</li>
    </ol>
    ...
    <ol class="left">
        ...
        <li>Kepala {{ $item->satker->kpknl }}.</li>
    </ol>
