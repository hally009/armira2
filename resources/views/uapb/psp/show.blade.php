            ...
            <div class="card-header pt-0 pe-0 pb-0">
                <div class="row">
                    <div class="col-md-6 bg-light ps-0 pe-0">
                        ...
                        <h6 class="mb-0 py-0 ms-3">Lampiran dokumen permohonan PSP</h6>
                    </div>
                    <div class="col-md-6 ps-0 align-self-center">
                        <div class="d-flex justify-content-end align-items-center">
                            @include('uapb.psp._table-show')
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row mt-3">
                    <div class="col-md-5 align-self-center">
                        <a type="button" href="{{ route('Uapb::psp.index') }}" class="btn btn-outline-secondary me-1">
                            Kembali
                        </a>
                    </div>
