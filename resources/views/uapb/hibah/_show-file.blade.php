<div class="row mt-3">
    <div class="col">
        <ul class="nav nav-tabs nav-tabs-bordered" id="borderedTab" role="tablist">
            ...
            @if($item->file)
            <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-sk" type="button" role="tab" aria-selected="false">SK HIBAH</button>
            </li>
            @endif
        ...
        <div class="tab-content pt-2" id="borderedTabContent">
            ...
            <div class="tab-pane fade" id="tab-sk" role="tabpanel">
                @include('uapb.hibah._embed', ['file' => $item->file])
            </div>
            @endif
        </div>
    </div>
