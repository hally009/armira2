...
<table class="table table-bordered border-{{ $item->status_text }}">
    <tbody>
        <tr>
            <td>
                @foreach(form_penghapusan($item->dokumen_id.'_'.$item->kategori_id)['form'] as $key => $value)
                <div class="row">
                ...
                <div class="row text-secondary">
                    <div class="col-2 col-sm-2">
                        <h1>
                            ...
                            <form id="del-form-{{ $item->id }}" action="{{ route('Satker::penghapusan.destroy', $item) }}"
                    ...
                    <div class="col-5 col-sm-5">
                        <a href="{{ route('Satker::penghapusan.show', $item) }}" class="btn btn-outline-secondary btn-sm">
