    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-9 mt-3">
                        <div class="row">
                            <div class="col-md-4">
                                <h5 class="card-title mb-0 py-0"><small>Nama Satker</small></h5>
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <h5 class="card-title mb-0 py-0"><small>Kanwil DJKN</small></h5>
                            </div>
                            <div class="col-md-8">
                                <p class="mb-0">{{ $item->djkn ?? "-"}}</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-md-4">
                                <h5 class="card-title mb-0 py-0"><small>KPKNL</small></h5>
                            </div>
                            <div class="col-md-8">
                                <p class="mb-0">{{ $item->kpknl ?? "-" }}</p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <p class="mb-0" id="name_pejabat">{{ $item->pejabat_pengesahan }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-footer">
                <div class="row">
                    <button class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#modal-satker">
                        UBAH
                    </button>
                </div>
            </div>
...
<div class="modal fade" id="modal-satker" tabindex="-1">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" action="{{ route('Satker::profile.store') }}" method="POST" enctype="multipart/form-data">
                    @method('POST')
                    @csrf
                    <div class="col-md-12">
...
<script>
    $("#tutup").click(function() {
        $("#modal-satker").modal('toggle')
        $("#pejabat_pengesahan").val($('#name_pejabat').text())
    })
