...
@endphp
<form action="{{ route('Satker::hibah.perbaikan.update', $item) }}" method="POST"
    ...
    <div class="row mb-3 mt-3">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="number" class="form-control" id="nilai_hibah" value="{{ $form->nilai_hibah }}" name="nilai_hibah">
        ...
        <div class="tab-content pt-2" id="borderedTabContent">
            ...
            <div class="tab-pane fade @if($loop->iteration == 1)  show active @endif" id="{{ $tab['id'] }}"
                ...
                <form id="{{ $tab['id_upload'] }}"
                    action="{{ route('Satker::hibah-perbaikan.upload-file', [$item->id, $tab['name_file']]) }}"
