            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-9 align-self-center">
                        ...
                        <h5 class="mb-0 py-0">
                            Status Permohonan PSP nomor tiket {{ $item->kode_transaksi }}
                        </h5>
                    </div>
                    <div class="col-md-3 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="{{ route('Satker::psp.index') }}" class="btn btn-outline-secondary">Kembali</a>
                            &nbsp;
                    ...
                    <div class="col-lg-7">
                        <table class="table table-bordered" style="font-size:12px">
                            <tbody>
                                ...
                                <tr>
                                    <td>Total Nilai Objek PSP</td>
                                    <td>{{ number_format($form->nilai_psp) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <div class="modal-dialog modal-fullscreen modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Perbaikan Permohonan PSP BMN</h5>
...
<script>
    ...
    $("#button-perbaikan").click(function() {
        $.ajax({
            url: "{{ route('Satker::psp.perbaikan.show', $item) }}",
