    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-footer">
                <div class="row">
                    <button class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#modal-apip">
                        UBAH
                    </button>
                </div>
            </div>
...
<div class="modal fade" id="modal-apip" tabindex="-1">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row g-3" action="{{ route('Apip::profile.store') }}" method="POST" enctype="multipart/form-data">
                    @method('POST')
                    @csrf
                    <div class="col-md-12">
